 ...
 */
#ifndef RTW_HEADER_project6_model_h_
#define RTW_HEADER_project6_model_h_
#include "rtw_modelmap.h"
#ifndef project6_model_COMMON_INCLUDES_
# define project6_model_COMMON_INCLUDES_
...
#endif                                 /* project6_model_COMMON_INCLUDES_ */

#include "project6_model_types.h"
...
#define project6_model_rtModel         rtModel_project6_model
...
typedef struct {
  ...
  real_T Channel0ofEncoderInputs;      /* '<Root>/Channel 0 of  Encoder Inputs ' */
  real_T MotorPosition;                /* '<Root>/angular_position =  [relative_count//COUNTS_PER_REV] *360 degrees' */
...
typedef struct {
  ...
  int_T Channel0ofEncoderInputs_IWORK[3];/* '<Root>/Channel 0 of  Encoder Inputs ' */
  int_T Channel0Controlsignaltomotort_j;/* '<Root>/Channel 0 -Control signal to  motor through amplifier ' */
  struct {
    int_T AcquireOK;
  ...
  struct {
    int_T AcquireOK;
  } SFunction_IWORK_a;                 /* '<S3>/S-Function' */

  struct {
    int_T AcquireOK;
  } SFunction_IWORK_aj;                /* '<S4>/S-Function' */
} D_Work_project6_model;

/* Continuous states (auto storage) */
typedef struct {
  real_T Integrator1_CSTATE;           /* '<Root>/Integrator1' */
} ContinuousStates_project6_model;

/* State derivatives (auto storage) */
typedef struct {
  real_T Integrator1_CSTATE;           /* '<Root>/Integrator1' */
} StateDerivatives_project6_model;

/* State disabled  */
typedef struct {
  boolean_T Integrator1_CSTATE;        /* '<Root>/Integrator1' */
} StateDisabled_project6_model;
...
#define rtB                            project6_model_B
#define BlockIO                        BlockIO_project6_model
#define rtX                            project6_model_X
#define ContinuousStates               ContinuousStates_project6_model
#define rtP                            project6_model_P
#define Parameters                     Parameters_project6_model
#define rtDWork                        project6_model_DWork
#define D_Work                         D_Work_project6_model

/* Parameters (auto storage) */
struct Parameters_project6_model_ {
  real_T Anglesetpoint_Value;          /* Expression: -15
  ...
  real_T Saturation_LowerSat;          /* Expression: -10
                                        * Referenced by: '<Root>/Saturation'
                                        */
  real_T Darknesssetpoint_Value;       /* Expression: 0
  ...
  real_T Channel0Controlsignaltomotorthr[2];/* Computed Parameter: Channel0Controlsignaltomotorthr
                                             ...
                                             */
  real_T Channel0Controlsignaltomotort_p;/* Expression: boardtype
                                          * Referenced by: '<Root>/Channel 0 -Control signal to  motor through amplifier '
                                          */
  real_T Channel0Controlsignaltomotort_a[2];/* Computed Parameter: Channel0Controlsignaltomotort_a
                                             * Referenced by: '<Root>/Channel 0 -Control signal to  motor through amplifier '
                                             */
  real_T Channel0Controlsignaltomotort_n[2];/* Expression: channel
                                             * Referenced by: '<Root>/Channel 0 -Control signal to  motor through amplifier '
                                             */
  ...
  real_T Channel0Controlsignaltomotort_b[2];/* Computed Parameter: Channel0Controlsignaltomotort_b
                                             * Referenced by: '<Root>/Channel 0 -Control signal to  motor through amplifier '
                                             */
  real_T Channel0Controlsignaltomotort_i;/* Expression: simul
                                          * Referenced by: '<Root>/Channel 0 -Control signal to  motor through amplifier '
                                          */
  real_T Channel0Controlsignaltomotort_f[2];/* Computed Parameter: Channel0Controlsignaltomotort_f
                                             * Referenced by: '<Root>/Channel 0 -Control signal to  motor through amplifier '
                                             */
  real_T Channel0Controlsignaltomotort_m[2];/* Expression: reset
                                             * Referenced by: '<Root>/Channel 0 -Control signal to  motor through amplifier '
                                             */
  real_T Channel0Controlsignaltomotor_pp[2];/* Computed Parameter: Channel0Controlsignaltomotor_pp
                                             * Referenced by: '<Root>/Channel 0 -Control signal to  motor through amplifier '
                                             */
  real_T Channel0Controlsignaltomotort_j[2];/* Expression: initValue
                                             * Referenced by: '<Root>/Channel 0 -Control signal to  motor through amplifier '
                                             */
  real_T Channel0Controlsignaltomotort_h[2];/* Computed Parameter: Channel0Controlsignaltomotort_h
                                             * Referenced by: '<Root>/Channel 0 -Control signal to  motor through amplifier '
                                             */
  real_T Channel0Controlsignaltomotor_l1;/* Expression: sampleTime
                                          * Referenced by: '<Root>/Channel 0 -Control signal to  motor through amplifier '
                                          */
  real_T Channel0Controlsignaltomotort_d[2];/* Computed Parameter: Channel0Controlsignaltomotort_d
                                             * Referenced by: '<Root>/Channel 0 -Control signal to  motor through amplifier '
                                             */
  real_T Channel0Controlsignaltomotor_co;/* Expression: pciBus
                                          * Referenced by: '<Root>/Channel 0 -Control signal to  motor through amplifier '
                                          */
  real_T Channel0Controlsignaltomotor_np[2];/* Computed Parameter: Channel0Controlsignaltomotor_np
                                             * Referenced by: '<Root>/Channel 0 -Control signal to  motor through amplifier '
                                             */
  real_T Channel0Controlsignaltomotort_e;/* Expression: pciSlot
                                          * Referenced by: '<Root>/Channel 0 -Control signal to  motor through amplifier '
                                          */
  real_T Gain_Gain;                    /* Expression: 1
                                        * Referenced by: '<Root>/Gain'
...
extern Parameters_project6_model project6_model_P;

/* Block signals (auto storage) */
extern BlockIO_project6_model project6_model_B;

/* Continuous states (auto storage) */
extern ContinuousStates_project6_model project6_model_X;

/* Block states (auto storage) */
extern D_Work_project6_model project6_model_DWork;

/* Model entry point functions */
extern void project6_model_initialize(void);
extern void project6_model_output(void);
extern void project6_model_update(void);
extern void project6_model_terminate(void);

/* Real-time Model object */
extern struct rtModel_project6_model *const project6_model_rtM;
 ...
 *
 * '<Root>' : 'project6_model'
 * '<S1>'   : 'project6_model/Data Display'
 * '<S2>'   : 'project6_model/error signal'
 * '<S3>'   : 'project6_model/motor position'
 * '<S4>'   : 'project6_model/setpoint'
 */
#endif                                 /* RTW_HEADER_project6_model_h_ */
